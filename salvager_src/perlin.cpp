...
std::vector< std::vector<int> > genHeightMapV(int w,int h, int sx, int sy, double zoom,double p, int o)//w and h speak for themselves, zoom wel zoom in and out on it, I usually
    ...
    for(int y=0; y < h; y++)
    {
        for(int x=0; x < w; x++)
        {
            ...
            for(int a=0; a < octaves-1; a++)//This loops trough the octaves.
            {
                ...
                getnoise += noise(((double)x + sx)*frequency/zoom,((double)y + sy)/zoom*frequency)*amplitude;//This uses our perlin noise functions. It calculates all our zoom and frequency and amplitude
