...
enum _GAMEOBJTYPES{OBJ_NONE, OBJ_MAPTILE, OBJ_PLAYER, OBJ_MONSTER, OBJ_ITEM_CONTAINER, OBJ_ITEM_CONTAINER_LIQUID,
                    OBJ_ITEM_MISC, OBJ_ITEM_PORTAL, OBJ_TOTAL};

enum _DIRECTIONS{DIR_NONE, DIR_SW, DIR_SOUTH, DIR_SE, DIR_WEST, DIR_SELF, DIR_EAST, DIR_NW, DIR_NORTH, DIR_NE, DIR_UP, DIR_DOWN, DIR_TOTAL};
